...
(async () => {
  ...
  try {
    ...
    /* ===== 6 tricies octies. {python-operations} : a et b se changent, les quatre lignes se tapent =====
    ...
    titre('6 tricies octies. LES QUATRE OPÉRATIONS : a ET b SE CHANGENT, LES QUATRE LIGNES SE TAPENT');
