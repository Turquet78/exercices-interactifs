...
(async () => {
  ...
  try {
    ...
    /* ===== 6 vicies duodecies. {python-print} : écrire un print, l'exécuter, le faire vérifier =====
    ...
    titre('6 vicies duodecies. ÉCRIRE UN PRINT : L\'EXÉCUTER, LE FAIRE VÉRIFIER, ET LE SOUTIEN QUI EXPLIQUE');
    if(!P.pythonPrint){
