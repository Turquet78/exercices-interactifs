...
(async () => {
  ...
  try {
    ...
    /* ===== 6 tricies septendecies. {python-echange-variables} : échanger deux
       ...
       est ce qui est PROPRE au 5.17 : les CINQ lignes du PDF (dont a et b sont
       ...
       modèle sur une idée en langage naturel (docs/journal/08). */
    titre('6 tricies septendecies. ÉCHANGER DEUX VARIABLES, PUIS EXPLIQUER');
