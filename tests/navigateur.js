...
(async () => {
  ...
  try {
    ...
    /* ===== 6 tricies quinquies. {suite-synthese-variations} : la fiche 3 entière =====
    ...
    titre('6 tricies quinquies. LA SYNTHÈSE SUR LES VARIATIONS : L\'ESCALIER, LA GRILLE ET LES CHAÎNES');
    if(!P.suiteSynthese){
