...
(async () => {
  ...
  try {
    ...
    /* ===== 6 tricies bis. {python-completer} : la ligne 2 se tape, s'exécute, puis se vérifie =====
    ...
    titre('6 tricies bis. AFFICHER UN TEXTE SUIVI D\'UNE VARIABLE : LA LIGNE SE TAPE, S\'EXÉCUTE, SE VÉRIFIE');
