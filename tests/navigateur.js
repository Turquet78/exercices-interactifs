...
(async () => {
  ...
  try {
    ...
    /* ===== 6 quater octies. les cinq tableaux du QCM écrivent leurs images,
       ...
       comme une chaîne. Ce qu'il ne voit pas, c'est la LEÇON DU 2.15 : le
       tableau au mauvais NOMBRE de variations porte une flèche de plus que le
       vrai, donc jusqu'à 746 px, quand une carte de la grille à deux colonnes
       en fait bien moins — et il vit dans un conteneur à overflow-x:auto qui
       le cacherait derrière un défilement que rien ne signale. On mesure donc
       chaque tableau contre sa carte, sur les trois questions de la séance, et
