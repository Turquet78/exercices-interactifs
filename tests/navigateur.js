...
(async () => {
  ...
  try {
    ...
    /* ===== 6 vicies duodecies. {python-nom-variable} : un nom par grandeur, puis le programme =====
    ...
    titre('6 vicies duodecies. NOMMER UNE VARIABLE : UN NOM PAR GRANDEUR, PUIS LE PROGRAMME');
