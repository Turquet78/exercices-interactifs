...
(async () => {
  ...
  try {
    ...
    /* ===== 6 tricies terdecies. {python-pas-a-pas} : les deux colonnes, la rangée choisie et tapée =====
    ...
    titre('6 tricies terdecies. LE PROGRAMME PAS À PAS : LES DEUX COLONNES, LA RANGÉE CHOISIE ET TAPÉE');
    if(!P.pythonPasAPas){
