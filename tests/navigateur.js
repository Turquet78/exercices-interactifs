...
(async () => {
  ...
  try {
    ...
    /* ===== 6 vicies terdecies. {suite-tcm-limite} : la fiche choisie et tapée pour de vrai =====
    ...
    titre('6 vicies terdecies. LA CONVERGENCE MONOTONE : LA FICHE CHOISIE ET TAPÉE POUR DE VRAI');
    if(!P.suiteTcmLimite){
