...
(async () => {
  ...
  try {
    ...
    /* ===== 6 vicies terdecies. {python-nom-variable} : un nom par grandeur, puis le programme =====
    ...
    titre('6 vicies terdecies. NOMMER UNE VARIABLE : UN NOM PAR GRANDEUR, PUIS LE PROGRAMME');
