...
(async () => {
  ...
  try {
    ...
    /* ===== 6 vicies terdecies. {python-print} : écrire un print, l'exécuter, le faire vérifier =====
    ...
    titre('6 vicies terdecies. ÉCRIRE UN PRINT : L\'EXÉCUTER, LE FAIRE VÉRIFIER, ET LE SOUTIEN QUI EXPLIQUE');
    if(!P.pythonPrint){
