...
{python-noms-variables} (Seconde, 5.2, demande de Turquet, septembre 2026 —
...
justification si c'est faux ») suit {python-affichage} au menu, repris de la
...
branchements ; le NAVIGATEUR (« 6 vicies undecies », déclaré par
