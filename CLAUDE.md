...
{python-noms-variables} (Seconde, 5.3, demande de Turquet, septembre 2026 —
...
justification si c'est faux ») suit {python-types} au menu, repris de la
...
branchements ; le NAVIGATEUR (« 6 vicies duodecies », déclaré par
